#ifndef	__SUNH5_ENGINE_H__
#define __SUNH5_ENGINE_H__
...
struct sunh5_engine_ops {
	 ...
	 */
	void (*atomic_begin)(struct sunh5_engine *engine,
	 ...
	 */
	int (*atomic_check)(struct sunh5_engine *engine,
	 ...
	 * This function is optional.
	 */
	void (*commit)(struct sunh5_engine *engine);
	 ...
	 * This function is optional.
	 */
	void (*apply_color_correction)(struct sunh5_engine *engine);
	 ...
	 * This function is optional.
	 */
	void (*disable_color_correction)(struct sunh5_engine *engine);
	 ...
	 * This function is optional.
	 */
	void (*vblank_quirk)(struct sunh5_engine *engine);
};

/**
 * struct sunh5_engine - the common parts of an engine for sun4i-drm driver
...
struct sunh5_engine {
	...
	const struct sunh5_engine_ops	*ops;
...
/**
 * sunh5_engine_layers_init() - Create planes (layers) for the engine
 * @drm:	pointer to the drm_device for which planes will be created
 * @engine:	pointer to the engine
 */
static inline struct drm_plane **sunh5_engine_layers_init(struct drm_device *drm, struct sunh5_engine *engine)
{
...
/**
 * sunh5_engine_commit() - commit all changes of the engine
 * @engine:	pointer to the engine
 */
static inline void sunh5_engine_commit(struct sunh5_engine *engine)
{
